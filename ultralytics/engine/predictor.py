...
class BasePredictor:
    ...
    def inference(self, im, *args, **kwargs):
        visualize = increment_path(self.save_dir / Path(self.batch[0][0]).stem, mkdir=True) if self.args.visualize and (not self.source_type.tensor) else False
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        for batch in self.dataset:
            ...
            # Preprocess
            with profilers[0]:
                im = self.preprocess(im0s)  # img to tensor
            ...
            # Postprocess
            with profilers[2]:
                # im: Tensor: (1, 3, 384, 640)
                # im0s: ndarray: (720, 1280, 3)
